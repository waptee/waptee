...
public abstract class DrEditServlet extends HttpServlet {
   ...
   * Application name.
   */
  public static final String APP_NAME = "waptee";
  ...
  public static final String LOCALHOST_CLIENT_SECRETS_FILE_PATH
      = "/WEB-INF/localhost_client_secrets.json";
  ...
  private GoogleClientSecrets getClientSecrets() {
    ...
    if (SystemProperty.environment.value() == 
      ...
      stream = getServletContext()
          .getResourceAsStream(LOCALHOST_CLIENT_SECRETS_FILE_PATH);
    } else {
      stream = getServletContext()
